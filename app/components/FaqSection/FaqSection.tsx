...
const faqs = [
  ...
  {
    id: 2,
    question: <>Чи можна повернути <span className={styles.accentText}>або</span> обміняти товар?</>,
  ...
  {
    id: 3,
    question: <>Яка якість <span className={styles.accentText}> шкіри </span> та як за нею доглядати?</>,
  ...
  {
    id: 4,
    question: <><span className={styles.accentText}>Як</span> здійснюється оплата замовлення?</>,
  ...
  {
    id: 5,
    question: <>Чи робите <span className={styles.accentText}>ви</span> індивідуальні замовлення?</>,
  ...
  {
    id: 6,
    question: <>Чи є <span className={styles.accentText}> гарантія </span> на вироби?</>,
